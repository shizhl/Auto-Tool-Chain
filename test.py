...
if __name__ == '__main__':
    data = load_data('D:/Paper2024/CodeTool/dataset/spotify.json')
    ...
    write_file(results, './logs/naive_results.spotify.5.2.json')
    results = evaluate(load_data('../logs/naive_results.spotify.5.2.json'))
    write_file(results, './logs/naive_results_exec.spotify.5.2.json')
